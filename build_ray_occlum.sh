...
docker run --rm  -it --device /dev/sgx/enclave --device /dev/sgx/provision --shm-size=1g \
                    --memory=11g \
                    -v `pwd`:/root/codes/occlum_ray/occlum-ray-docker \
                    -v `pwd`/tmp/ray:/root/codes/occlum_ray/occlum-ray-docker/tmp/ray \
                    -v `pwd`:/root/codes/occlum_ray/occlum-ray-docker/tmp/ray/train  \
